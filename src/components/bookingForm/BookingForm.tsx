...
//     const priceNum = parseFloat(price || "0");
//     const daysNum = formData.days || 1;
//     const calculatedPrice = priceNum * daysNum;
//     setFormData((prev) => ({
//       ...prev,
//       totalPrice: Number(calculatedPrice.toFixed(2)), // Round to 2 decimal places
//     }));
//   }, [formData.days, price]);
...
//         departurePoint: "",
//         arrivalPoint: "",
//         totalPrice: parseFloat(price || "0") || 0, // Reset to base price
//         days: 1,
//         rentalDate: "",
//       });
//       setTimeout(() => {
...
//               className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-100"
//               placeholder="Total price (calculated)"
//               readOnly // Make totalPrice read-only since it's calculated
//             />
//             <label
//               htmlFor="days"
//               className="block text-sm font-medium text-gray-700 mb-1"
